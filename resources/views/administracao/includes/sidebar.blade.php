<nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
               {{--  <li class="nav-item">
                ...
                --}}
                <li class="nav-item">
                  <a href="{{url('admin/subscricoes')}}" class="nav-link">Todas</a>
                </li>
          ...
          <li class="nav-item">
            <a href="{{url('admin/subscritores')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                <li class="nav-item">
                     <a href="{{url('admin/topicos')}}" class="nav-link">Topicos</a>
                </li>
                <li class="nav-item">
                  <a href="{{url('admin/perguntas/lista')}}" class="nav-link">Perguntas</a>
                </li>
        ...
        {{--  <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
              ...
              <li class="nav-item">
                  <a href="{{url('admin/usuarios')}}" class="nav-link">Usuarios</a>
                </li>
                {{--<li class="nav-item">
                  <a href="{{url('admin/perfil')}}" class="nav-link">Perfil</a>
                </li>--}}
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a href="{{url('admin/simulador')}}" target="_blank" class="nav-link">
              <i class="link-icon" data-feather="hash"></i>
