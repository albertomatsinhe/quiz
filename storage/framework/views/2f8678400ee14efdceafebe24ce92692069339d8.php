...
<?php $__env->startSection('conteudo'); ?>
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Dados dos Subscritores </li>
            </ol>
          </nav>
          <div class="row">
               ...
               <div class="card">
                <div class="card-header">
                  <div class="row row-sm align-items-center">
                    <div class="col-2 col-xl">Subscritores</div>
                  
                    <div class="col-2">
                     <?php /*  <button type="button" class="btn btn-block btn-outline-success" id="novo_registo">Novo</button>*/ ?>
                    </div>
                  </div>
