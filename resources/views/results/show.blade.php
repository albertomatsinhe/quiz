...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <a href="{{ route('testss.index') }}" class="btn btn-default">responder novamente</a>
            <a href="{{ route('results.index') }}" class="btn btn-default">Meus resultados</a>
        </div>
    </div>
@stop
