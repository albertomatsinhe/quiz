...
<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo e(url('admin/subscricoes')); ?>">Subscrições</a></li>
          ...
          estado*/ ?>
				...
				<div class="row">
					<div class="col-md-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Dados da Subscrição #<?php echo e($subscricao->codigo); ?></h4>
								<h4 class="card-title">Cliente <?php echo e($subscricao->cliente); ?> ||  <?php echo e($subscricao->numero); ?></h4>
                <p class="card-description mb-0">Topico : <?php echo e($subscricao->topico); ?></p>
							</div>
						</div>
          </div>
          <div class="col-md-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
							 	Estados: <button type='button' class='btn btn-outline-success btn-xs'><?php echo e($subscricao->estado); ?></button>
								<h4 class="card-title">Inicio <?php echo e(formatDate($subscricao->data_inicio)); ?>  Fim  <?php echo e(formatDate($subscricao->data_fim)); ?></h4>
                <p class="card-description mb-0">PONTOS  : <?php echo e($subscricao->pontos); ?></p>
							</div>
						</div>
          </div>
        </div>
          ...
          <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
              <div class="card-body d-flex flex-column align-items-center">
                   <p class="card-description"><?php echo e($detalhe->pergunta); ?></p>
                   Resposta dada 
                    <?php if($detalhe->correcta=="yes"): ?>
...
$('#post').DataTable({
  "aLengthMenu": [
     ...
     "serverSide": true,
     "ajax":{
              "url": "<?php echo e(url('admin/subscricoes/post')); ?>",
              "dataType": "json",
              "type": "POST",
