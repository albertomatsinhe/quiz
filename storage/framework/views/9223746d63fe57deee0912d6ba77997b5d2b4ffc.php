                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h3 class="mb-2"><?php echo e(number_format($clientesTotal,2,'.',',')); ?></h3>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h5 class="mb-2"><?php echo e(number_format($subscricoesDiarias,2,'.',',')); ?></h3>
                        <div class="d-flex align-items-baseline">
                          <p class="text-info">
                            <span><?php echo e(number_format($facturacoesDiarias,2,'.',',')); ?> (MT)</span>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-5">
                        <h3 class="mb-2"><?php echo e(number_format($subscricoesMensais,2,'.',',')); ?></h3>
                        <div class="d-flex align-items-baseline">
                          <p class="text-success">
                            <span><?php echo e(number_format($facturacoesMensais,2,'.',',')); ?> (MT)</span>
                            <i data-feather="arrow-up" class="icon-sm mb-1"></i>
                          </p>
                        </div>
                      </div>
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom pb-3">
                    ...
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                        <h6 class="text-body mb-2"><?php echo e($rank->numero); ?></h6>
                        <p class="text-muted tx-12"><?php echo e($rank->total); ?></p>
                      </div>
                      <p class="text-muted tx-13"><?php echo e($rank->nome); ?></p>
                    </div>
                  </a>
                  <br>
                  <?php endforeach; ?>
          ...
          <div class="col-lg-4 col-xl-4 grid-margin grid-margin-xl-0 stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex flex-column">
                <?php foreach($clientes as $topico): ?>
                  ...
                  <a href="#" class="d-flex align-items-center border-bottom pb-3">
                    ...
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                        <h6 class="text-body mb-2"><?php echo e($topico->numero); ?></h6>
                        <p class="text-muted tx-12"><?php echo e(\Carbon\Carbon::parse($topico->data)->format('d/m/Y')); ?></p>
                      </div>
                      <p class="text-muted tx-13"><?php echo e($topico->nome); ?></p>
                    </div>
                  </a>
                  <br>
                  <?php endforeach; ?>
                  ...
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      ...
                      <?php foreach($topicos as $topico): ?>
                        <tr>
                          <td><?php echo e($topico->id); ?></td>
                          <td><?php echo e($topico->descricao); ?></td>
                          <td><?php echo e(\Carbon\Carbon::parse($topico->data_inicio)->format('d/m/Y')); ?></td>
                          <td><?php echo e(\Carbon\Carbon::parse($topico->data_fim)->format('d/m/Y')); ?></td>
                          <td>
                              <?php if($topico->estado=="activo"): ?>
                              <span class="badge badge-success"><?php echo e($topico->estado); ?></span>
                              <?php else: ?>
                                <span class="badge badge-danger"><?php echo e($topico->estado); ?></span>
                              <?php endif; ?>
                           </td>
                        </tr>
...
<script src="<?php echo e(asset('public/template/assets/vendors/chartjs/Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/vendors/jquery.flot/jquery.flot.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/vendors/jquery.flot/jquery.flot.resize.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/vendors/apexcharts/apexcharts.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/vendors/progressbar.js/progressbar.min.js')); ?>"></script>


<script src="<?php echo e(asset('public/template/assets/js/dashboard.js')); ?>"></script>
<script src="<?php echo e(asset('public/template/assets/js/chat.js')); ?>"></script>


<script type="text/javascript">
 var baseUrl1= $('#Url_geral').val(); 

 var subscricoesMensais ="<?php echo e($facturacoesMensais); ?>";
 var setembro ="<?php echo e($Setembro); ?>";
...
$('#post').DataTable({
  "aLengthMenu": [
     ...
     "serverSide": true,
     "ajax":{
              "url": "<?php echo e(url('admin/subscritores/post')); ?>",
              "dataType": "json",
              "type": "POST",
...
$(document).on('click', '#confirm-delete .btn-ok', function(){
 ...
 function CancelarElemente(id){
       $.ajax({
            "url": "<?php echo e(url('venda_dinheiro/cancelar')); ?>",
             mehtod:"get",
