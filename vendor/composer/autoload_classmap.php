...
return array(
    'ActualizarTabelas' => $baseDir . '/database/migrations/2018_04_20_082916_actualizar_tabelas.php',
    ...
    'BankAccountTypeTableSeeder' => $baseDir . '/database/seeds/BankAccountTypeTableSeeder.php',
    'BankTransactionTableSeeder' => $baseDir . '/database/seeds/BankTransactionTableSeeder.php',
    'CountryListTableSeeder' => $baseDir . '/database/seeds/CountryListTableSeeder.php',
    'Cpdf' => $vendorDir . '/dompdf/dompdf/lib/Cpdf.php',
    'CreatePurchaseOrdersTable' => $baseDir . '/database/migrations/2019_05_18_121220_create_purchase_orders_table.php',
    'CurrencyTableSeeder' => $baseDir . '/database/seeds/CurrencyTableSeeder.php',
    'CustomerBranchTableSeeder' => $baseDir . '/database/seeds/CustomerBranchTableSeeder.php',
    'DatabaseSeeder' => $baseDir . '/database/seeds/DatabaseSeeder.php',
    'DebtorMasterTableSeeder' => $baseDir . '/database/seeds/DebtorMasterTableSeeder.php',
    'EmailConfigTableSeeder' => $baseDir . '/database/seeds/EmailConfigTableSeeder.php',
    'EmailTempDetailsTableSeeder' => $baseDir . '/database/seeds/EmailTempDetailsTableSeeder.php',
    ...
    'IncomeExpenseCategoryTableSeeder' => $baseDir . '/database/seeds/IncomeExpenseCategoryTableSeeder.php',
    'InvoicePaymentTermsTableSeeder' => $baseDir . '/database/seeds/InvoicePaymentTermsTableSeeder.php',
    'ItemCodeTableSeeder' => $baseDir . '/database/seeds/ItemCodeTableSeeder.php',
    'ItemTaxTypesTableSeeder' => $baseDir . '/database/seeds/ItemTaxTypesTableSeeder.php',
    'ItemUnitTableSeeder' => $baseDir . '/database/seeds/ItemUnitTableSeeder.php',
    ...
    'MoedasTableSeeder' => $baseDir . '/database/seeds/MoedasTableSeeder.php',
    ...
    'OrderCustomItemTableSeeder' => $baseDir . '/database/seeds/OrderCustomItemTableSeeder.php',
    ...
    'PaymentHistoryTableSeeder' => $baseDir . '/database/seeds/PaymentHistoryTableSeeder.php',
    ...
    'PreferenceTableSeeder' => $baseDir . '/database/seeds/PreferenceTableSeeder.php',
    'PurchaseOrderDetailTableSeeder' => $baseDir . '/database/seeds/PurchaseOrderDetailTableSeeder.php',
    'PurchaseOrderTableSeeder' => $baseDir . '/database/seeds/PurchaseOrderTableSeeder.php',
    'PurchasePriceTableSeeder' => $baseDir . '/database/seeds/PurchasePriceTableSeeder.php',
    ...
    'SalesOrderDetailTableSeeder' => $baseDir . '/database/seeds/SalesOrderDetailTableSeeder.php',
    'SalesOrderTableSeeder' => $baseDir . '/database/seeds/SalesOrderTableSeeder.php',
    'SalesPriceTableSeeder' => $baseDir . '/database/seeds/SalesPriceTableSeeder.php',
    'SalesTypesTableSeeder' => $baseDir . '/database/seeds/SalesTypesTableSeeder.php',
    ...
    'SecurityRoleTableSeeder' => $baseDir . '/database/seeds/SecurityRoleTableSeeder.php',
    'StockCategoryTableSeeder' => $baseDir . '/database/seeds/StockCategoryTableSeeder.php',
    'StockMasterTableSeeder' => $baseDir . '/database/seeds/StockMasterTableSeeder.php',
    'StockMoveTableSeeder' => $baseDir . '/database/seeds/StockMoveTableSeeder.php',
    'SupplierTableSeeder' => $baseDir . '/database/seeds/SupplierTableSeeder.php',
    'TaxasTableSeeder' => $baseDir . '/database/seeds/TaxasTableSeeder.php',
