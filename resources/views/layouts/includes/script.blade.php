...
<script src="{{asset('public/dist/js/jquery.jkey.js')}}"></script>
...
$(document).jkey('f10',function(){
        ...
        var baseUrl1= SITE_URL;
        //window.location.replace(baseUrl1+'/manage/ticket');
        window.location.replace(baseUrl1+'/sales/consumo/list');
